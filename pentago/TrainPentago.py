...
from .PentagoGame import PentagoGame
from .PentagoNet import PentagoNetWrapper

PENTAGO_DIR = os.path.dirname(os.path.abspath(__file__))
...
args = Namespace(
    ...
    checkpoint = os.path.join(PENTAGO_DIR, './checkpoints/'),
    load_model  = False,
    load_folder_file = (os.path.join(PENTAGO_DIR, './checkpoints/'), 'best.pth.tar'),
    numItersForTrainExamplesHistory = 20,
)

if __name__ == '__main__':
    game = PentagoGame()
    net = PentagoNetWrapper(game)
